...
from ocisessionmanager.modules.config import APP_NAME, config  # Import config instance
from ocisessionmanager.modules.ssh_connection import SSHConnection
from ocisessionmanager.modules.utils import icon_path
from ocisessionmanager.ui.connection_tab import ConnectionTab
from ocisessionmanager.ui.logging_tab import LoggingTab
from ocisessionmanager.ui.settings_tab import SettingsTab
from ocisessionmanager.ui.theme import ThemeManager
...
class App(IApp, Frame):
    ...
    def on_connection_change(self, connected: bool):
        ...
        img_path = icon_path("green" if connected else "red")
