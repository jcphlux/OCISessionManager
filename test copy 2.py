...
class InputsAndButtonsDemo(ttk.Frame):
    ...
    def add_widgets(self):
        ...
        self.togglebutton = ttk.Checkbutton(
            self, text="Toggle me!", style="Toggle.TButton"
        )
...
class PanedDemo(ttk.PanedWindow):
    ...
    def add_widgets(self):
        ...
        self.progress = ttk.Progressbar(
            self.tab_1, value=0, variable=self.var, mode="determinate"
        )
...
class App(ttk.Frame):
    def __init__(self, parent):
        ...
        CheckBoxDemo(self).grid(
            row=0, column=0, padx=(0, 10), pady=(0, 20), sticky="nsew"
        )
        ...
        PanedDemo(self).grid(
            row=0, column=3, rowspan=2, padx=10, pady=(10, 0), sticky="nsew"
        )
